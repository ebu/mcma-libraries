...
namespace Mcma.Api.Routing.Defaults
{
    public static class DefaultRoutes
    {
        ...
        public static DefaultRouteCollectionBuilder<T> Builder<T>(IDocumentDatabaseTableProvider dbTableProvider, string root = null)
        ...
        public static DefaultRouteCollectionBuilder<JobAssignment> ForJobs<T>(IDocumentDatabaseTableProvider dbTableProvider, string root = null)
            where T : IWorkerInvoker, new()
            => Builder<JobAssignment>(dbTableProvider, root).ForJobs<T>();
        ...
        public static DefaultRouteCollectionBuilder<JobAssignment> ForJobs(
            ...
            => Builder<JobAssignment>(dbTableProvider, root).ForJobs(workerInvoker, contextVariables);
        ...
        public static DefaultRouteCollectionBuilder<JobAssignment> ForJobs(
            ...
            string root = null,
            Func<McmaApiRequestContext, IDictionary<string, string>> contextVariables = null)
            => Builder<JobAssignment>(dbTableProvider, root).ForJobs(createWorkerInvoker, contextVariables);
