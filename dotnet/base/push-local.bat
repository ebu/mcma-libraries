...
dotnet nuget push base/Mcma.Data/bin/packages/Mcma.Data.%1.nupkg -s=Local

dotnet pack base/Mcma.Worker -p:PackageVersion=%1
dotnet nuget push base/Mcma.Worker/bin/packages/Mcma.Worker.%1.nupkg -s=Local

dotnet pack base/Mcma.Api -p:PackageVersion=%1
dotnet nuget push base/Mcma.Api/bin/packages/Mcma.Api.%1.nupkg -s=Local