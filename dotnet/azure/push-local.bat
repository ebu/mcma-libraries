...
dotnet nuget push azure/Mcma.Azure.Client/bin/packages/Mcma.Azure.Client.%1.nupkg -s=Local

dotnet pack azure/Mcma.Azure.CosmosDb -p:PackageVersion=%1
dotnet nuget push azure/Mcma.Azure.CosmosDb/bin/packages/Mcma.Azure.CosmosDb.%1.nupkg -s=Local

dotnet pack azure/Mcma.Azure.Functions.Logging -p:PackageVersion=%1
dotnet nuget push azure/Mcma.Azure.Functions.Logging/bin/packages/Mcma.Azure.Functions.Logging.%1.nupkg -s=Local
...
dotnet nuget push azure/Mcma.Azure.Functions.Worker/bin/packages/Mcma.Azure.Functions.Worker.%1.nupkg -s=Local